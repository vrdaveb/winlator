...
import static com.winlator.x11.CmdEntryPoint.ACTION_START;
import static com.winlator.x11.LoriePreferences.ACTION_PREFERENCES_CHANGED;
...
import com.winlator.x11.input.InputEventSender;
import com.winlator.x11.input.InputStub;
import com.winlator.x11.input.TouchInputHandler;
import com.winlator.x11.utils.FullscreenWorkaround;
import com.winlator.x11.utils.KeyInterceptor;
import com.winlator.x11.utils.SamsungDexUtils;
import com.winlator.x11.utils.TermuxX11ExtraKeys;
import com.winlator.x11.utils.X11ToolbarViewPager;
...
public class X11Activity extends AppCompatActivity implements View.OnApplyWindowInsetsListener {
    public static final String ACTION_STOP = "com.winlator.x11.ACTION_STOP";
    public static final String ACTION_CUSTOM = "com.winlator.x11.ACTION_CUSTOM";
