package com.winlator.x11.utils;

import static com.winlator.shared.termux.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
import static com.winlator.x11.X11Activity.toggleKeyboardVisibility;
...
import com.winlator.shared.termux.extrakeys.*;
import com.winlator.x11.LoriePreferences;
...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.winlator.x11.start_preferences_activity";
