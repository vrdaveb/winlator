...
public class TouchInputHandler {
    ...
    /**
     * Set to true when the image has been zoomed
    */
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (!(mInputStrategy instanceof InputStrategyInterface.TrackpadInputStrategy)) {
                ...
                // direct input and simulated touch mode.
                moveCursorToScreenPoint(e2.getX(), e2.getY());
            }
            if (mInputStrategy instanceof InputStrategyInterface.SimulatedTouchInputStrategy && !mIsDragging) {
                    mInputStrategy.onScroll(distanceX, distanceY);
            }    
            return true;
        }
            ...
            if (e.getPointerCount() == 1) {
                switch(e.getActionMasked()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (mInputStrategy instanceof InputStrategyInterface.SimulatedTouchInputStrategy)
                            onTap(1, e.getX(), e.getY());
        ...
        public void onLongPress(int pointerCount, float x, float y) {
            ...
            if (!(mInputStrategy instanceof InputStrategyInterface.TrackpadInputStrategy)) {
             ...
             if (pointerCount == 1 && mInputStrategy instanceof InputStrategyInterface.SimulatedTouchInputStrategy)
                onTap(2, x, y);
